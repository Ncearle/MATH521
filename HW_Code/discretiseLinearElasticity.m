...
%ASSEMBLEMASS Assembles the complete stiffness matrix including all boundary
...
kij =1/4*[dot(msh.D32,msh.D32)./msh.A dot(msh.D32,msh.D13)./msh.A dot(msh.D32,msh.D21./msh.A);
    dot(msh.D13,msh.D32)./msh.A dot(msh.D13,msh.D13)./msh.A dot(msh.D13,msh.D21./msh.A);
    dot(msh.D21,msh.D32)./msh.A dot(msh.D21,msh.D13)./msh.A dot(msh.D21,msh.D21./msh.A)]; % entries of the element mass matrices
...
%======================================
% % Using for loop, my attempt from HW5
%======================================
