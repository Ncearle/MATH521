...
GammaD = @(x1,x2) true(size(x1)); % use Dirichlet conditions everywhere
% GammaD = @(x1,x2) false(size(x1)); % use homogeneous Neumann conditions everywhere
% GammaD = @(x1,x2) x1 < 1 | x2 > .6; % use mixed boundary conditions
